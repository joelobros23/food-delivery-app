...
// This is now a responsive sidebar/drawer.
...
<div id="sidebar-drawer" class="fixed inset-y-0 left-0 bg-white shadow-lg w-64 transform -translate-x-full md:translate-x-0 md:relative md:w-64 z-40 transition-transform duration-300 ease-in-out">
    ...
    <ul class="flex flex-col py-4">
        <!-- These links are hidden on mobile and only appear on desktop -->
        <li class="hidden md:flex">
            <a href="customer_dashboard.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600 <?php echo ($active_page == 'dashboard') ? 'bg-orange-100 border-r-4 border-orange-500 text-orange-600' : ''; ?>">
                <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i data-lucide="home"></i></span>
                <span class="text-sm font-medium">Dashboard</span>
            </a>
        </li>
        <li class="hidden md:flex">
            <a href="search.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600 <?php echo ($active_page == 'search') ? 'bg-orange-100 border-r-4 border-orange-500 text-orange-600' : ''; ?>">
                <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i data-lucide="search"></i></span>
                <span class="text-sm font-medium">Search</span>
            </a>
        </li>
        <li class="hidden md:flex">
            <a href="orders.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600 <?php echo ($active_page == 'orders') ? 'bg-orange-100 border-r-4 border-orange-500 text-orange-600' : ''; ?>">
        ...
        <!-- These links appear on both mobile and desktop -->
         <li>
            <a href="favorites.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600 <?php echo ($active_page == 'favorites') ? 'bg-orange-100 border-r-4 border-orange-500 text-orange-600' : ''; ?>">
         ...
         <li>
            <a href="settings.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600 <?php echo ($active_page == 'settings') ? 'bg-orange-100 border-r-4 border-orange-500 text-orange-600' : ''; ?>">
                <span class="inline-flex items-center justify-center h-12 w-12 text-lg"><i data-lucide="settings"></i></span>
                <span class="text-sm font-medium">Settings</span>
            </a>
        </li>
        <li>
            <a href="logout.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-600 hover:text-orange-600">
